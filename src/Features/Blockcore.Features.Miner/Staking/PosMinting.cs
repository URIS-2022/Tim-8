...
namespace Blockcore.Features.Miner.Staking
{
    ...
    public class PosMinting : IPosMinting, INetworkWeight
    {
        ...
        public async Task<bool> CreateCoinstakeAsync(List<UtxoStakeDescription> utxoStakeDescriptions, BlockTemplate blockTemplate, ChainedHeader chainTip, long searchInterval, long fees, CoinstakeContext coinstakeContext)
        {
            ...
            Transaction coinstakeTx = PrepareCoinStakeTransactions(chainTip.Height, coinstakeContext, coinstakeOutputValue, eventuallyStakableUtxosCount, ourWeight, reward);
