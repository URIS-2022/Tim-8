...
namespace Blockcore.Networks.Cybits.Deployments
{
    /// <summary>
    /// BIP9 deployments for the Blockcore sample coin network.
    /// </summary>
    public class CybitsBIP9Deployments : Bip9DeploymentsArray
    {
        ...
        /// </summary>
        public CybitsBIP9Deployments() : base(NumberOfDeployments)
        {
        }
