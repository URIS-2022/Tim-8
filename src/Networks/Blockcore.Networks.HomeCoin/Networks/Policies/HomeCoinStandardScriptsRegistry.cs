...
namespace HomeCoin.Networks.Policies
{
    /// <summary>
    /// HomeCoin coin-specific standard transaction definitions.
    /// </summary>
    public class HomeCoinStandardScriptsRegistry : StandardScriptsRegistry
    {
