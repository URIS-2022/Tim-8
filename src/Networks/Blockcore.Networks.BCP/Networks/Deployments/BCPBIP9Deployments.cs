...
namespace Blockcore.Networks.BCP.Networks.Deployments
{
    /// <summary>
    /// BIP9 deployments for the Blockcore sample coin network.
    /// </summary>
    public class BCPBIP9Deployments : Bip9DeploymentsArray
    {
        ...
        /// </summary>
        public BCPBIP9Deployments() : base(NumberOfDeployments)
        {
        }
